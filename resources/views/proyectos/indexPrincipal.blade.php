                            ...
                            <div class="item-wrapper">
                                <figure>
                                    <div class="image img-responsive"
                                         style="background-image:url('/images/proyecto/{{$proyecto->imagen}}');"></div>
                                ...
                                <div class="item-content">
                                    ...
                                    @endif
                                    <h3>{{substr(strip_tags($proyecto->titulo), 0,78)}}...</h3>
                                    <p>{{substr(strip_tags($proyecto->resumenLargo), 0,160)}}...</p>
